                ...
                <ToastContainer
                    ...
                    <div className="addon-details-column" id="addon-details-right-column">
                        ...
                        <div className="addon-details-segment" id="addon-details-column-actions">
                            ...
                            <a rel="noreferrer noopener" target="_blank" href={`https://github.com/${pluginData?.repoOwner}/${pluginData?.repoName}/tree/${pluginData?.commitId}`} className="btn btn-secondary" id="view-source">
                            ...
                            {pluginData?.skin_data?.funding?.kofi && <a href={`https://ko-fi.com/${pluginData?.skin_data?.funding?.kofi}`} className="btn btn-primary" id="kofi-btn">
                        ...
                        <span className="addon-metadata-row">
                            <strong>Size: </strong> {FormatBytes(pluginData?.fileSize)} </span>
                        <span className="addon-metadata-row">
                            <strong>Stargazers: </strong> {FormatNumber(pluginData?.stargazerCount)} </span>
                        <span className="addon-metadata-row">
                            <strong>Downloads: </strong> {FormatNumber(pluginData?.downloadCount)} </span>
                        <span className="addon-metadata-row">
                            <strong>Last Updated: </strong>{pluginData?.commitDate && DateToString(pluginData?.commitDate)} </span>
                        <span className="addon-metadata-row">
                            <strong>Id: </strong>{pluginData?.id}</span>
                        <span className="addon-metadata-row">
                            <strong>Source: </strong>
                            <a rel="noreferrer noopener" target="_blank" className="anchor" href={`https://github.com/${pluginData?.repoOwner}/${pluginData?.repoName}/tree/${pluginData?.commitId}`}>{`https://github.com/${pluginData?.repoOwner}/${pluginData?.repoName}/tree/${pluginData?.commitId}`}</a>
                        </span>
                        </section>
                    </div>
