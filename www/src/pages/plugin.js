                ...
                <div className="addon-details-column" id="addon-details-right-column">
                    ...
                    <div className="addon-details-segment" id="addon-details-column-actions">
                        ...
                        <div className="btn-container direction-column">
                            ...
                            <a rel="noreferrer noopener" target="_blank" href={`https://github.com/${pluginData?.repoOwner}/${pluginData?.repoName}/`} className="btn btn-secondary" id="view-source">
                        ...
                        <span className="addon-metadata-row">
                            ...
                            <a rel="noreferrer noopener" target="_blank" className="anchor" href={`https://github.com/${pluginData?.repoOwner}/${pluginData?.repoName}`}>{`https://github.com/${pluginData?.repoOwner}/${pluginData?.repoName}`}</a>
                        </span>
                        </section>
                    </div>
