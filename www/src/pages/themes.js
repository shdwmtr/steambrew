				...
				<section id="addons-header" className="page-section content-header">
					<div className="page-section-inner flex-container justify-between align-center" id="theme-header">
						<div className="header-left">
							...
							<p className="title-tooltip add-new">
								<a href="https://github.com/SteamClientHomebrew/Millennium/issues/new?assignees=&labels=enhancement&projects=&template=THEME-SUBMISSION.yml&title=%5BSubmission%5D">Have your own theme to add here?</a>
							</p>
						</div>
					</div>
				</section>
