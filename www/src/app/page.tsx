...
function RenderHome() {
	...
	return (
		<>
			...
			<style>{`.footer-container footer#section-footer { background: #0a0a0a !important; } html { overflow: hidden !important; }`}</style>
						...
						<div className="features-view">
							<div className="feature" id="feature-1" ref={feature1Ref}>
								...
								<div className="feature-info">
									...
									<p className="title-description" style={{ fontSize: '16px' }}>
