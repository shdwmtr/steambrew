            ...
            />
              ...
              <div className="addon-details-column" id="addon-details-right-column">
                  <div className="addon-details-segment" id="addon-details-column-actions">
                    ...
                    <a target="_blank" href={`https://github.com/${json?.repoOwner}`} className="addon-author-container">
                        <img loading="lazy" src={`https://github.com/${json?.repoOwner}.png`}/>
                        <h5>{json?.repoOwner}</h5>
                    </a>
                    <h1 className="title">{json?.pluginJson?.common_name ?? json?.repoName}</h1>
                    <div className="title-description theme-desc">
                      ...
                      <span className="addon-metadata-row">
                          <strong>Last Updated: </strong>{json?.commitDate && DateToString(json?.commitDate)} </span>
                      <span className="addon-metadata-row">
                          <strong>Id: </strong>{json?.id}</span>
                      <span className="addon-metadata-row">
                          <strong>Source: </strong>
                          <a rel="noreferrer noopener" target="_blank" className="anchor" href={`https://github.com/${json?.repoOwner}/${json?.repoName}`}>{`https://github.com/${json?.repoOwner}/${json?.repoName}`}</a>
                      </span>
                      </section>
                  </div>
